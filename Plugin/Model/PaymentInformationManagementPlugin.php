...
namespace Twinsen\CarrierCodeFix\Plugin\Model;
...
class PaymentInformationManagementPlugin
{
    ...
    public function aroundSavePaymentInformation(\Magento\Checkout\Model\PaymentInformationManagement $subject, callable $proceed, $cartId,
